...
static parameter_t parameters[] =
  {
    ...
    [PARAM_WATER_VOL_ADD] = { .max_value = UINT16_MAX, .default_value = 100, .name = "PARAM_WATER_VOL_ADD" },
    ...
    [PARAM_SILOS_SENSOR_IS_CONNECTED] = { .max_value = 1, .default_value = 0, .name = "PARAM_SILOS_SENSOR_IS_CONNECTED" },
    ...
    [PARAM_PULSES_PER_LITER] = { .min_value = 10, .max_value = 10000, .default_value = 100, .name = "PARAM_PULSES_PER_LITER" },
    [PARAM_PWM_VALVE] = { .min_value = 30, .max_value = 100, .default_value = 50, .name = "PARAM_PWM_VALVE" },
    [PARAM_TANK_SIZE] = { .min_value = 100, .max_value = 8000, .default_value = 150, .name = "PARAM_TANK_SIZE" },
    [PARAM_WATER_FLOW_STATE] = { .min_value = 0, .max_value = 10, .default_value = 0, .name = "PARAM_WATER_FLOW_STATE" },
